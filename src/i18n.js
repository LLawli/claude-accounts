...
const STRINGS = {
  en: {
    ...
    switchPartial: (n) => `partial switch to '${n}': live credentials were written but not finalized. Re-run: switch ${n}`,
  ...
  pt: {
    ...
    switchPartial: (n) => `troca parcial para '${n}': credenciais ativas foram gravadas mas nao finalizadas. Rode de novo: switch ${n}`,
